...
<x-layout.app-admin title="{!! __('Tambah Anggota') !!}">
    <style>
    ...
    <div class="row" style="margin-left: 8px; margin-right: 8px;">
        <div class="col-12">
            <div class="card">
                <!-- /.card-header -->
                <form action="{{ route('anggota.store') }}" method="POST" id="form-input"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" id="name" class="form-control"
                                                value="{{ old('name') }}" placeholder="Nama Anggota">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="umur" id="umur" class="form-control"
                                                value="{{ old('umur') }}" placeholder="Umur Anggota">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="geoloc5" type="hidden" value="" size="20" />
                                        <div id="fixedMapCont"
