<x-layout.app-admin title="{!! __('Anggota') !!}">
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{!! __('Anggota') !!}</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-9 text-right">
                            @if (auth()->user()->can('create anggota'))
                                <a href="{{ route('anggota.create') }}" type="button" class="btn btn-success">
                                    Tambah {!! __('Anggota') !!}
                                </a>
                            @endif
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="table-responsive">
                                <table id="tbl-anggota" class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
