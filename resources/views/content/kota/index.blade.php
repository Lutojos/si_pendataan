<x-layout.app-admin title="{!! __('Kota') !!}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 text-right">
                            @if (auth()->user()->can('create kota'))
                                <a href="{{ route('kota.create') }}" type="button" class="btn btn-success">
                                    Tambah {!! __('Kota') !!}
                                </a>
                            @endif
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="table-responsive">
                                <table id="tbl-kota" class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
