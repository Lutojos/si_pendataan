<x-layout.app-admin title="{!! __('Edit Kota') !!}">
    <div class="row" style="margin-left: 8px; margin-right: 8px;">
        <div class="col-12">
            <div class="card">
                <!-- /.card-header -->
                <form action="{{ route('kota.update', ['token' => $datas->_token]) }}" method="POST" id="form-edit"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="kota_name" id="kota_name" class="form-control"
                                                value="{{ old('kota_name', $datas->kota_name) }}" placeholder="Nama Kota">
                                        </div>
                                    </div>
                                </div>
                                <hr>
