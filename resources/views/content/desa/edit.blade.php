<x-layout.app-admin title="{!! __('Edit Desa') !!}">
    <div class="row" style="margin-left: 8px; margin-right: 8px;">
        <div class="col-12">
            <div class="card">
                <!-- /.card-header -->
                <form action="{{ route('desa.update', ['token' => $datas->_token]) }}" method="POST" id="form-edit"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="desa_name" id="desa_name"
                                                class="form-control" value="{{ old('desa_name', $datas->desa_name) }}"
    ...
    @push('scripts')
        <script>
            ...
            $(document).ready(function() {
                ...
                loadKecamatan( $( '#kecamatan_id' ), "{{ $datas->kota_id }}", "{{ $datas->kecamatan_id }}" );
