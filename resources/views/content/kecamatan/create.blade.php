<x-layout.app-admin title="{!! __('Tambah Kecamatan') !!}">
    <div class="row" style="margin-left: 8px; margin-right: 8px;">
        <div class="col-12">
            <div class="card">
                <!-- /.card-header -->
                <form action="{{ route('kecamatan.store') }}" method="POST" id="form-input" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="kecamatan_name" id="kecamatan_name"
                                                class="form-control" value="{{ old('kecamatan_name') }}"
